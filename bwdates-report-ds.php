...
if ($result) {
echo '<script>alert("Votre demande de test a été soumise avec succès. Le numéro de commande est "+"'.$orderno.'")</script>';
  echo "<script>window.location.href='registered-user-testing.php'</script>";
} 
else {
    echo "<script>alert('Il y'a un proplème essayer une autre fois.');</script>";  
echo "<script>window.location.href='registered-user-testing.php'</script>";
}
}
?>
...
<head>
    ...
    <title>Rechercher les rapports avec leurs date</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Rechercher les rapports avec leurs date</h1>
...
<div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" value="Rechercher">                           
                             </div>
