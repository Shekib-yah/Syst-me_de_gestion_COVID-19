...
<head>
    ...
    <title>Résultat des recherches</title>
...
?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Résultat des recherches<?php echo $searchdata;?>' </h1>
    

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tous les résultats de recherche selon votre demande</h6>
                        </div>
                        <div class="card-body">
...
?>
  ...
  <a href="test-details.php?tid=<?php echo $row['testid'];?>&&oid=<?php echo $row['OrderNumber'];?>" class="btn btn-info btn-sm" target="blank"> Détails </a> 
