...
<?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"> Administration des employés</h1>
...
?>
                                ...
                                <a href="manage-phlebotomist.php?pid=<?php echo $row['id'];?>&&action=delete" onclick="return confirm('Êtes-vous sûr de vouloir supprimer l'employé ???');"><i class="fa fa-trash" aria-hidden="true" style="color:red" title="Supprimer l'employé  "></i></a></td>
                                        </tr>
                               <?php } ?>
                                    </tbody>
                                </table>
