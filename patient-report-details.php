        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"> Rapport du test <?php echo intval($_GET['oid']);?></h1>
<div class="row">
<?php 
...
<!-- personal information --->
 ...
 <table class="table table-bordered"  width="100%" cellspacing="0">
    ...
    <td><?php echo $row['GovtIssuedId'];?></td>
     ...
     <tr>
    <th> Numéro du preuve personnelle </th> 
...
<!-- Test Information --->
                         <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"> Informations du test</h6>
                                </div>
                                <div class="card-body">

 <table class="table table-bordered"  width="100%" cellspacing="0">
    <tr>
    <th> Numéro di test</th> 
    ...
    <tr>
    <th>  Date de réalisation du test</th> 
...
<?php if($row['AssignedtoEmpId']!=''):?>
  <tr>
    ...
    <tr>
    <th>La date de réalisation du test</th> 
...
<?php if($row['FinalReport']!=''):?>
  <tr>
    ...
    <tr>
    <th>  Date de réalisation du rapport</th> 
...
<h4 align="center" style="color:red"> Il n'y a aucune nouvelle concernant l'état de votre test. Veuillez essayer 4 heures après avoir donné l'échantillon pour examen </h4>
         <?php } ?>           
