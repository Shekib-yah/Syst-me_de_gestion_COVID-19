...
?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"> Les test depuis <?php echo $fdate;?> jusqu'à <?php echo $tdate;?> </h1>
    

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Les rapports selon la date</h6>
                        </div>
                        <div class="card-body">
