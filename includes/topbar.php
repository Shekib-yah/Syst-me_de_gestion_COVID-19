...
while($row=mysqli_fetch_array($query)){
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="test-details.php?tid=<?php echo $row['id'];?>&&oid=<?php echo $row['OrderNumber'];?>">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">Demander un autre test avec le numéro <?php echo $row['OrderNumber'];?></span>
                                    </div>
                                </a>
                            <?php }} else{?>
                                <p style="color:red">Aucune nouvelle notifications</p>
                            <?php } ?>
                            
                                <a class="dropdown-item text-center small text-gray-500" href="new-test.php"> Toutes les notifications</a>
                            </div>
                        </li>
