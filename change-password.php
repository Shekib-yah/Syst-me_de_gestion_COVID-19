...
<head>
    ...
    <title>Modifer le mot depaase</title>
...
<?php include_once('includes/sidebar.php');?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Modifier le mot de passe</h1>
  ...
  <div class="row">
     ...
     <div class="form-group">
        ...
        <div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" id="submit" value="Modifier" >                           
                             </div>                                        
